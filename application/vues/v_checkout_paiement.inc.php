            ...
            <div class="payment-options">
                ...
                <div class="payment-option active">
                    <div class="payment-header">
                        ...
                        <div class="payment-icons">
                            <img src="public/images/payment/carte.png" alt="Carte bancaire">
                ...
                <div class="payment-option">
                    <div class="payment-header">
                        ...
                        <div class="payment-icons">
                            <img src="public/images/payment/paypalicon.png" alt="PayPal">
                            <span class="payment-arrow"></span>
                        </div>
                    </div>
                        ...
                        <div class="form-actions">
                            <div class="paypal-buttons">
                                <button type="button" class="paypal-button paypal-button-primary paypal-button-disabled" id="paypal-standard-button" disabled>
                                    <img src="public/images/payment/paypalicon.png" alt="PayPal" class="paypal-logo">
                                </button>
                                <button type="button" class="paypal-button paypal-button-secondary paypal-button-disabled" id="paypal-4x-button" disabled>
                                    <div class="paypal-4x">
                                        <img src="public/images/payment/paypalicon.png" alt="PayPal" class="paypal-small-logo">
                                        <span>4X PayPal</span>
                                    </div>
                                </button>
                            </div>
                ...
                <div class="payment-option">
                    <div class="payment-header">
                        ...
                        <div class="payment-icons">
                            <img src="public/images/payment/floa3x4x.svg" alt="FLOA">
                            <span class="payment-arrow"></span>
                        </div>
                    </div>
                    <div class="payment-content" style="display:none;">
