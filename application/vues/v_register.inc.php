...
<body class="auth-page">
    <div class="auth-container">
        ...
        <form class="auth-form" action="index.php?controleur=Client&action=traiterInscription&display=minimal" method="post">
            ...
            <div class="form-row date-inputs">
                ...
                <a href="index.php?controleur=Client&action=afficherConnexion&display=minimal" class="btn btn-back">Retour</a>
