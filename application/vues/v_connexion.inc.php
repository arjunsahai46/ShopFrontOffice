...
<body class="auth-page">
    <div class="auth-container">
        ...
        <form class="auth-form" action="index.php?controleur=Client&action=traiterConnexion&display=minimal" method="post">
            ...
            <div class="auth-links">
                <a href="#" class="link">Obtenir votre ID</a>
                <a href="index.php?controleur=Client&action=afficherInscription&display=minimal" class="link">Créer un compte</a>
            </div>
