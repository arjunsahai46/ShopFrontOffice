-- Script d'initialisation de la base de données prin_boutique
-- Ce script est exécuté automatiquement par MySQL au démarrage du conteneur Docker

-- Créer la base de données si elle n'existe pas
CREATE DATABASE IF NOT EXISTS prin_boutique CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Utiliser la base de données
USE prin_boutique;

-- Donner les permissions à l'utilisateur cedric
GRANT ALL PRIVILEGES ON prin_boutique.* TO 'cedric'@'%';
FLUSH PRIVILEGES;
...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 02 juin 2025 à 13:22
...
CREATE DEFINER=`root`@`localhost` FUNCTION `CalculerTotalCommande` (`idCmd` INT) RETURNS DECIMAL(10,2) READS SQL DATA BEGIN
...
INSERT INTO `panier_produit` (`id`, `idPanier`, `idProduit`, `quantite`) VALUES
(513, 1, 20, 1),
(512, 1, 4, 1),
(511, 1, 7, 1);
...
(1, 'NZXT H510', 'Boîtier PC Moyen Tour - ATX / Micro ATX / Mini ITX - Verre trempé', 79.99, 'nzxt_h510.jpg', 1, 1, -13),
(2, 'Fractale Design Meshify C', 'Boîtier PC Moyen Tour - ATX / Micro ATX / Mini ITX - Verre trempé', 89.00, 'fractal_design_meshify_c.jpg', 1, 1, 36),
(3, 'Corsair iCUE 220T RGB', 'Boîtier PC Moyen Tour - ATX / Micro ATX / Mini ITX - Verre trempé', 99.99, 'corsair_icue_220t_rgb.jpg', 1, 1, 26),
(4, 'Corsair RM750x - 750W', 'Alimentation 750W ATX 12V 2.52 - Modulaire - 80 PLUS Gold', 109.99, 'corsair_rm750x_750w.jpg', 2, 1, 52),
(5, 'Seasonic Focus GX-650 - 650W', 'Alimentation 650W ATX 12V 2.52 - Modulaire - 80 PLUS Gold', 99.99, 'seasonic_focus_gx650_650w.jpg', 2, 1, 69),
...
(7, 'Seagate Barracuda 2 To', 'Disque dur interne 3.5\" - 7200 tr/min - Cache 256 Mo - SATA 6Gb/s', 59.99, 'seagate_barracuda_2to.jpg', 3, 1, 95),
(8, 'Western Digital WD Blue 4 To', 'Disque dur interne 3.5\" - 5400 tr/min - Cache 64 Mo - SATA 6Gb/s', 89.99, 'western_digital_wd_blue_4to.jpg', 3, 1, 78),
(9, 'Toshiba P300 1 To', 'Disque dur interne 3.5\" - 7200 tr/min - Cache 64 Mo - SATA 6Gb/s', 44.99, 'toshiba_p300_1to.jpg', 3, 1, 61),
(10, 'Samsung 970 EVO Plus 1 To', 'SSD M.2 NVMe PCIe 3.0 x4 - Lecture 3500 Mo/s - Ecriture 3300 Mo/s - Mémoire TLC 3D V-NAND', 149.99, 'samsung_970_evo_plus_1to.jpg', 4, 2, 54),
...
(12, 'Western Digital Blue SN550 2 To', 'SSD M.2 NVMe PCIe 3.0 x4 - Lecture 2400 Mo/s - Ecriture 1950 Mo/s - Mémoire TLC 3D NAND', 199.99, 'western_digital_blue_sn550_2to.jpg', 4, 2, 35),
...
(16, 'NVIDIA GeForce RTX 3060 Ti', 'Carte graphique NVIDIA GeForce RTX 3060 Ti - 8 Go GDDR6 - Interface PCI-Express 4.0', 399.99, 'nvidia_geforce_rtx_3060_ti.jpg', 6, 3, 80),
(17, 'AMD Radeon RX 6800 XT', 'Carte graphique AMD Radeon RX 6800 XT - 16 Go GDDR6 - Interface PCI-Express 4.0', 699.99, 'amd_radeon_rx_6800_xt.jpg', 6, 3, 90),
...
(20, 'G.Skill Ripjaws V Series 32 Go (2 x 16 Go) DDR4 36', 'Kit mémoire DDR4 PC4-28800 - F4-3600C16D-32GVKC (garantie à vie par G.Skill)', 159.99, 'gskill_ripjaws_v_series_32go_ddr4_3600mhz.jpg', 7, 4, 119),
...
(26, 'Cooler Master Hyper 212 Black Edition', 'Ventirad tour simple - Socket AMD AM4 / Intel LGA1200 / LGA1151', 49.99, 'cooler_master_hyper_212_black_edition.jpg', 9, 5, 180),
...
(1, 'Chef', 'prin34', 'princhef@sio.net', 1, '614e26f34c646d45c2adc89aa6c9591f60bfbc0f4159e47c2edda1459b80412a'),
